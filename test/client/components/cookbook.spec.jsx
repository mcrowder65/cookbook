...
describe('Cookbook', () => {
  ...
  it('Test mapStateToProps', () => {
    ...
    expect(container.find('Cookbook').prop('recipes')).to.equal(initialState.recipes);
    expect(container.find('Cookbook').prop('addingNewRecipe')).to.equal(
      initialState.addingNewRecipe);
    expect(container.find('Cookbook').prop('editingRecipe')).to.equal(initialState.editingRecipe);
  });
